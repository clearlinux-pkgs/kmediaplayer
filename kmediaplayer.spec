...
Source0  : https://download.kde.org/stable/frameworks/5.55/portingAids/kmediaplayer-5.55.0.tar.xz
Source99 : https://download.kde.org/stable/frameworks/5.55/portingAids/kmediaplayer-5.55.0.tar.xz.sig
...
export LANG=C
export SOURCE_DATE_EPOCH=1549905358
mkdir -p clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
/usr/lib64/libKF5MediaPlayer.so.5.55.0
