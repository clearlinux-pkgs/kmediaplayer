...
Version  : 5.108.0
Release  : 57
URL      : https://download.kde.org/stable/frameworks/5.108/portingAids/kmediaplayer-5.108.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.108/portingAids/kmediaplayer-5.108.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.108/portingAids/kmediaplayer-5.108.0.tar.xz.sig
...
%prep
%setup -q -n kmediaplayer-5.108.0
cd %{_builddir}/kmediaplayer-5.108.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1689010532
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF5MediaPlayer.so.5.108.0
/usr/lib64/libKF5MediaPlayer.so.5
/usr/lib64/libKF5MediaPlayer.so.5.108.0
