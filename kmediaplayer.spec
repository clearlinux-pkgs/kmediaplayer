...
Source0  : https://download.kde.org/stable/frameworks/5.49/portingAids/kmediaplayer-5.49.0.tar.xz
...
export LANG=C
export SOURCE_DATE_EPOCH=1535143557
mkdir clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
/usr/lib64/libKF5MediaPlayer.so.5.49.0
