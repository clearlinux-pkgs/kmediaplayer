...
Source0  : https://download.kde.org/stable/frameworks/5.63/portingAids/kmediaplayer-5.63.0.tar.xz
Source1 : https://download.kde.org/stable/frameworks/5.63/portingAids/kmediaplayer-5.63.0.tar.xz.sig
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1570991163
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5MediaPlayer.so.5.63.0
