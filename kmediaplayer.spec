...
Source0  : https://download.kde.org/stable/frameworks/5.111/portingAids/kmediaplayer-5.111.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.111/portingAids/kmediaplayer-5.111.0.tar.xz.sig
...
%prep
%setup -q -n kmediaplayer-5.111.0
cd %{_builddir}/kmediaplayer-5.111.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698158655
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF5MediaPlayer.so.5.111.0
/usr/lib64/libKF5MediaPlayer.so.5
/usr/lib64/libKF5MediaPlayer.so.5.111.0
