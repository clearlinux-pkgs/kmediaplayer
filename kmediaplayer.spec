...
Source0  : https://download.kde.org/stable/frameworks/5.88/portingAids/kmediaplayer-5.88.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.88/portingAids/kmediaplayer-5.88.0.tar.xz.sig
...
%prep
%setup -q -n kmediaplayer-5.88.0
cd %{_builddir}/kmediaplayer-5.88.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1637010837
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kmediaplayer-5.88.0/LICENSE %{buildroot}/usr/share/package-licenses/kmediaplayer/08ffcf85a07d9a9f1101498127ec1b932b47b74b
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5MediaPlayer.so.5.88.0
