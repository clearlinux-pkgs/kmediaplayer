...
Source0  : https://download.kde.org/stable/frameworks/5.114/portingAids/kmediaplayer-5.114.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.114/portingAids/kmediaplayer-5.114.0.tar.xz.sig
...
%prep
%setup -q -n kmediaplayer-5.114.0
cd %{_builddir}/kmediaplayer-5.114.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1705505682
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF5MediaPlayer.so.5.114.0
/usr/lib64/libKF5MediaPlayer.so.5
/usr/lib64/libKF5MediaPlayer.so.5.114.0
