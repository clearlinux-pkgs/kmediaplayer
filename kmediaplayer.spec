...
Source0  : https://download.kde.org/stable/frameworks/5.64/portingAids/kmediaplayer-5.64.0.tar.xz
Source1 : https://download.kde.org/stable/frameworks/5.64/portingAids/kmediaplayer-5.64.0.tar.xz.sig
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1573430089
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kmediaplayer-5.64.0/LICENSE %{buildroot}/usr/share/package-licenses/kmediaplayer/08ffcf85a07d9a9f1101498127ec1b932b47b74b
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5MediaPlayer.so.5.64.0
