...
Source0  : https://download.kde.org/stable/frameworks/5.100/portingAids/kmediaplayer-5.100.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.100/portingAids/kmediaplayer-5.100.0.tar.xz.sig
...
%prep
%setup -q -n kmediaplayer-5.100.0
cd %{_builddir}/kmediaplayer-5.100.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1668455519
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5MediaPlayer.so.5.100.0
