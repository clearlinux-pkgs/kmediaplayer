...
Source0  : https://download.kde.org/stable/frameworks/5.51/portingAids/kmediaplayer-5.51.0.tar.xz
Source99 : https://download.kde.org/stable/frameworks/5.51/portingAids/kmediaplayer-5.51.0.tar.xz.sig
...
export LANG=C
export SOURCE_DATE_EPOCH=1539701589
mkdir -p clr-build
pushd clr-build
%cmake ..
...
/usr/lib64/libKF5MediaPlayer.so.5.51.0
